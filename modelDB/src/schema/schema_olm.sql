...
CREATE  TABLE IF NOT EXISTS `discs_model`.`element` (
  ...
  INDEX `FK_element_element_type_id` (`element_type_id` ASC) ,
  INDEX `FK_element_beamline_sequence_id` (`beamline_sequence_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`lattice` (
  ...
  INDEX `FK_lattice_model_line_id` (`model_line_id` ASC) ,
  INDEX `FK_lattice_machine_mode_id` (`machine_mode_id` ASC) ,
  INDEX `FK_lattice_model_geometry_id` (`model_geometry_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`model` (
  ...
  INDEX `FK_model_lattice_id` (`lattice_id` ASC) ,
  INDEX `FK_model_model_code_id` (`model_code_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`beam_parameter` (
  ...
  INDEX `FK_beam_parameter_model_id` (`model_id` ASC) ,
  INDEX `FK_beam_parameter_element_id` (`element_id` ASC) ,
  INDEX `FK_beam_parameter_particle_type` (`particle_type` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`beam_parameter_prop` (
  ...
  `trnsfer_matrix` VARCHAR(255) NULL DEFAULT NULL ,
  `beam_parameter_id` INT(11) NULL DEFAULT NULL ,
  PRIMARY KEY (`beam_parameter_prop_id`) ,
  INDEX `FK_beam_parameter_prop_beam_parameter_id` (`beam_parameter_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`blsequence_lattice` (
  ...
  INDEX `FK_blsequence_lattice_beamline_sequence_id` (`beamline_sequence_id` ASC) ,
  INDEX `FK_blsequence_lattice_lattice_id` (`lattice_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`element_type_prop` (
  ...
  INDEX `FK_element_type_prop_element_type_id` (`element_type_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`element_prop` (
  ...
  INDEX `FK_element_prop_element_id` (`element_id` ASC) ,
  INDEX `FK_element_prop_element_type_prop_id` (`element_type_prop_id` ASC) ,
  INDEX `FK_element_prop_lattice_id` (`lattice_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`gold_lattice` (
  ...
  `lattice_id` INT(11) NULL DEFAULT NULL ,
  PRIMARY KEY (`gold_id`) ,
  INDEX `FK_gold_lattice_lattice_id` (`lattice_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`gold_model` (
  ...
  INDEX `FK_gold_model_model_id` (`model_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `discs_model`.`rf_gap` (
  ...
  INDEX `FK_rf_gap_cavity_id` (`cavity_id` ASC) ,
