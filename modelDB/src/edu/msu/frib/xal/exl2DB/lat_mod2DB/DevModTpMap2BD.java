    ...
    public static void instDB(ArrayList mapData) {
        ...
        while (it.hasNext()) {
            ...
            if (et == null) {
                ...
                ElementTypeProp etp = new ElementTypePropAPI().getElementTypePropByElementType(element_type);             
                if (etp != null) {
                    System.out.println("The element_type_prop with the element_type_name " + element_type + " is already in the database! Please don't insert repeatedly!");
                } else {                 
