 ...
 */
package org.heps.param_list.entity;
...
public class DataPK implements Serializable {
    ...
    public String toString() {
        return "org.heps.param_list.entity.DataPK[ teamid=" + teamid + ", systemid=" + systemid + ", attributeid=" + attributeid + ", parameterid=" + parameterid + " ]";
    }
